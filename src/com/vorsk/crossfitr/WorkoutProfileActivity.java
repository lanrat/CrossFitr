...
public class WorkoutProfileActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TextView startButton = (TextView) findViewById(R.id.button_begin_workout);
		startButton.setTypeface(font);
		// TextView tvrecordType =
		// (TextView)findViewById(R.id.workout_profile_recordtypeDB);

		// set the texts of the TextView objects from the data retrieved from
		// the DB

		//type = WorkoutModel.getTypeName(workout.workout_type_id);
		...
		tvbestRecord.setText("Personal Record: " + StopwatchActivity.formatElapsedTime(Long
				.parseLong(String.valueOf(workout.record))));
